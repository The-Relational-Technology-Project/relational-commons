...
studio: "rt-studio"
license: "RCL-1.0"
tags: ["commons/prompt", "studio/rt-studio", "Events--Gatherings"]
topics: ["Events & Gatherings"]
...
> Create tools for neighbors to organize memorable block parties with sign-ups, task coordination, and event planning features.
...
- Grew from [Block Party Organizing](../tool/block-party-organizing.md)

---

*Contributed by Relational Tech Studio library. Licensed [RCL-1.0](https://relationalbuilder.org/commons/license). [On the web](https://relationalbuilder.org/commons/e/block-party-organizing).*
