---
title: "Hyperlocal Neighbor Hubs"
slug: "hyperlocal-neighbor-hubs"
kind: "prompt"
studio: "rt-studio"
license: "RCL-1.0"
tags: ["commons/prompt", "studio/rt-studio", "Neighborhood-Sites"]
topics: ["Neighborhood Sites"]
...
> Design a complete neighborhood website with member directories, local news, events calendar, and community discussion forums.
...
- Grew from [Hyperlocal Neighbor Hub](../tool/hyperlocal-neighbor-hub.md)
- Mentions: [Block Party](../reference/block-party.md)

---

*Contributed by Relational Tech Studio library. Licensed [RCL-1.0](https://relationalbuilder.org/commons/license). [On the web](https://relationalbuilder.org/commons/e/hyperlocal-neighbor-hubs).*
