---
title: "Neighbor Story Sharing"
slug: "neighbor-story-sharing"
kind: "prompt"
studio: "rt-studio"
license: "RCL-1.0"
tags: ["commons/prompt", "studio/rt-studio", "Connection--Stories"]
topics: ["Connection & Stories"]
attribution_source: "Relational Tech Studio library"
parent: "../tool/neighbor-story-sharing.md"
web: "https://relationalbuilder.org/commons/e/neighbor-story-sharing"
created: "2026-06-10"
updated: "2026-08-19"
rtp_id: "48c27ed4-fa18-4cad-927e-11e024e7d54e"
---
# Neighbor Story Sharing

> Build a platform where neighbors can share their stories, dreams, and visions. Perfect for strengthening community bonds through personal narratives.
...
We'll notify authors of interest.
When 2–3 neighbors express interest, authors may choose to organize a meetup.
Meet at a local coffee shop/library to share and connect.
Button: Next.
...
- Grew from [Neighbor Story Sharing](../tool/neighbor-story-sharing.md)
- Mentions: [GitHub](../tool/github.md)
- Mentions: [Story Circles](../story/story-circles.md)

---

*Contributed by Relational Tech Studio library. Licensed [RCL-1.0](https://relationalbuilder.org/commons/license). [On the web](https://relationalbuilder.org/commons/e/neighbor-story-sharing).*
