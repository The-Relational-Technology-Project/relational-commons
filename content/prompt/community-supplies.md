...
studio: "rt-studio"
license: "RCL-1.0"
tags: ["commons/prompt", "studio/rt-studio", "Resource-Sharing"]
...
> Build a sharing platform where neighbors can borrow and lend tools, supplies, and resources to reduce waste and build connections.
...
Welcome Email – "Thanks for joining the party! Here's how to start sharing and borrowing."  
New Listing Confirmation – Sent when someone adds a supply.  
Borrow Request – Notifies the owner when someone reaches out.  
Reminder Emails – Gentle reminders for return deadlines (configurable by steward).  
Thank You Email – Encourages borrower to send a quick thank-you note after using.  \n\nExample User Stories
...
- Grew from [Local Supplies Sharing](../tool/local-supplies-sharing.md)
- Mentioned in: [An Outer Sunset Story](../story/an-outer-sunset-story.md)
- Mentions: [Block Party](../reference/block-party.md)
- Mentioned in: [Three Layers of Neighborhood Infrastructure](../methodology/three-layers-of-neighborhood-infrastructure.md)

---

*Contributed by Relational Tech Studio library. Licensed [RCL-1.0](https://relationalbuilder.org/commons/license). [On the web](https://relationalbuilder.org/commons/e/community-supplies).*
